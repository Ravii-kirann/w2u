  ...
  "node_modules/preline/src/plugins/select/index.ts"() {
    ...
    HSSelect = class _HSSelect extends HSBasePlugin {
      constructor(el, options) {
        ...
        __publicField(this, "apiLoadMore");
        __publicField(this, "apiFieldsMap");
        __publicField(this, "apiIconTag");
        __publicField(this, "apiSelectedValues");
        ...
        __publicField(this, "dropdownAutoPlacement");
        ...
        __publicField(this, "isSelectedOptionOnTop");
        ...
        this.apiLoadMore = (concatOptions == null ? void 0 : concatOptions.apiLoadMore) === true ? {
          perPage: 10,
          scrollThreshold: 100
        } : typeof (concatOptions == null ? void 0 : concatOptions.apiLoadMore) === "object" && (concatOptions == null ? void 0 : concatOptions.apiLoadMore) !== null ? {
        ...
        this.apiSelectedValues = (concatOptions == null ? void 0 : concatOptions.apiSelectedValues) || null;
        this.currentPage = 0;
        ...
        this.dropdownAutoPlacement = (concatOptions == null ? void 0 : concatOptions.dropdownAutoPlacement) || false;
        ...
        this.isSelectedOptionOnTop = (concatOptions == null ? void 0 : concatOptions.isSelectedOptionOnTop) ?? true;
      ...
      setToggleIcon() {
        ...
        if (icon) {
          ...
          icon.append(img);
          if (!(img == null ? void 0 : img.src)) icon.classList.add("hidden");
      ...
      setToggleTitle() {
        ...
        if (this.optionAllowEmptyOption && this.value === "") {
          ...
          value = (emptyOption == null ? void 0 : emptyOption.title) || this.placeholder;
        } else if (this.value) {
          if (this.apiUrl) {
      ...
      buildTagsItem(val) {
        ...
        if (this.apiUrl && ((_e = this.apiFieldsMap) == null ? void 0 : _e.title) && item[this.apiFieldsMap.title]) {
      ...
      async loadMore() {
        ...
        try {
          ...
          const paginationParam = ((_a = this.apiFieldsMap) == null ? void 0 : _a.page) || ((_b = this.apiFieldsMap) == null ? void 0 : _b.offset) || "page";
          const isOffsetBased = !!((_c = this.apiFieldsMap) == null ? void 0 : _c.offset);
          ...
          url.searchParams.set(
            ((_d = this.apiFieldsMap) == null ? void 0 : _d.limit) || "limit",
            perPage.toString()
          );
      ...
      async apiRequest(val = "") {
        ...
        try {
          ...
          if (this.apiLoadMore) {
            const paginationParam = ((_a = this.apiFieldsMap) == null ? void 0 : _a.page) || ((_b = this.apiFieldsMap) == null ? void 0 : _b.offset) || "page";
            const isOffsetBased = !!((_c = this.apiFieldsMap) == null ? void 0 : _c.offset);
            const limitParam = ((_d = this.apiFieldsMap) == null ? void 0 : _d.limit) || "limit";
            const perPage = typeof this.apiLoadMore === "object" ? this.apiLoadMore.perPage : 10;
      ...
      setNewValue() {
        if (this.mode === "tags") {
          ...
          if (this.optionAllowEmptyOption && this.value === "") {
            ...
            this.toggleTextWrapper.innerHTML = (emptyOption == null ? void 0 : emptyOption.title) || this.placeholder;
          } else {
            if (this.value) {
              if (this.apiUrl) {
    ...
    HSRangeSlider = class _HSRangeSlider extends HSBasePlugin {
      constructor(el, options, events) {
        ...
        this.currentValue = this.concatOptions.currentValue ? Array.from(this.concatOptions.currentValue) : Array.from(
          ((_a = this.wrapper) == null ? void 0 : _a.querySelectorAll(".hs-range-slider-current-value")) || []
        );
      ...
      updateCurrentValue(values) {
        ...
        values.forEach((value, index) => {
          var _a;
          const element = (_a = this.currentValue) == null ? void 0 : _a[index];
          if (!element) return;
...
var HSCarousel = class _HSCarousel extends HSBasePlugin {
  ...
  detectDirection() {
    ...
    if (!this.isInfiniteLoop) {
      if (end < start && this.currentIndex < this.slides.length - this.getCurrentSlidesQty()) this.goToNext();
...
var HSComboBox = class _HSComboBox extends HSBasePlugin {
  constructor(el, options, events) {
    ...
    __publicField(this, "preventClientFiltering");
    ...
    this.preventClientFiltering = (options == null ? void 0 : options.preventClientFiltering) ?? (!!(concatOptions == null ? void 0 : concatOptions.apiSearchQuery) || !!(concatOptions == null ? void 0 : concatOptions.apiSearchPath));
  ...
  static setHighlighted(prev, current, input) {
    current.focus();
    input.value = current.querySelector("[data-hs-combo-box-value]").textContent;
  ...
  static onEnter(evt) {
    ...
    if (target.hasAttribute("data-hs-combo-box-input")) {
      ...
      opened.element.close(
        !opened.element.preventSelection ? evt.target.querySelector(
...
init_base_plugin();
var _HSThemeSwitch = class _HSThemeSwitch extends HSBasePlugin {
  constructor(el, options) {
    super(el, options);
  ...
  addSystemThemeObserver() {
    ...
    _HSThemeSwitch.systemThemeObserver = (e2) => {
      var _a;
      (_a = window.$hsThemeSwitchCollection) == null ? void 0 : _a.forEach((instance) => {
        if (localStorage.getItem("hs_theme") === "auto") {
          instance.element.setAppearance(e2.matches ? "dark" : "default", false);
        }
      });
    };
...
__publicField(_HSThemeSwitch, "systemThemeObserver", null);
var HSThemeSwitch = _HSThemeSwitch;
window.addEventListener("load", () => {
...
var HSTooltip = class _HSTooltip extends HSBasePlugin {
  ...
  buildFloatingUI() {
    ...
    const checkSpaceAndAdjust = (x, y, placement) => {
      ...
      if (placement.includes("right") && x + contentRect.width > availableWidth) {
      ...
      } else if (placement.includes("bottom") && y + contentRect.height > viewportHeight) {
